...
.PHONY: all irqtop netping flowgen check check-irqtop check-netping check-flowgen install install-irqtop install-netping install-flowgen

all: irqtop netping flowgen
...
check: check-irqtop check-netping check-flowgen
...
install: install-irqtop install-netping install-flowgen
